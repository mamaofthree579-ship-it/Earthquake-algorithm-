...
# ===============================
st.set_page_config(page_title="IHRAS Scientific Research Platform", layout="wide")
...
workflow_orchestrator = init_engine("workflow_orchestrator", lambda: AutonomousWorkflowOrchestrator(cluster, lineage_core))
civilization_kernel = init_engine("civilization_kernel", lambda: AutonomousScientificCivilizationKernel(workflow_orchestrator, governance_layer, lineage_core))
...
graph_visualizer = init_engine("graph_visualizer", lambda: KnowledgeGraphVisualizer(memory_graph))
hypothesis_engine = init_engine("hypothesis_engine", lambda: SelfEvolvingHypothesisEngine(memory_graph, meta_kernel, adaptive_ai))
...
# ===============================
# Self-Evolving Hypothesis Panel
# ===============================
